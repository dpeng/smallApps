...
backup code
	...
	*/
#define MAX_ITEM_SHOW_IN_LIST 256
#define TITLE_STRING_FONT_HEIGHT 24
#define SUBTITLE_STRING_FONT_HEIGHT 16
#define SEARCH_RESULT_ITEM_HEIGHT (TITLE_STRING_FONT_HEIGHT + SUBTITLE_STRING_FONT_HEIGHT + 5)
#define SEARCH_BOX_BODER_HEIGHT 4
